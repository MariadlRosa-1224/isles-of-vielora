...
- ## Basic info
  ...
  **Age:** Almost as old as the universe
  
  **Birthdate:** undefined
  
  **Gender:** Female?
  
  **Race:** [Guardian]([[guardians]]) - (Order)
  
  **Job:** Guardian of order
-
...
- **Height:** 200 cm
  ...
  **Weight:** undefined
-
- **Body:** somewhat muscular yet slim and delicate
-
- **Eye color:** eye color
...
- ## Personality
  ...
  **Description:** Strict and disiplined, never shows her feelings and for her, the mission of her existance is first, she cares for no more to prevent the destruction of the universe, or so she tells herself. Lonely and introverted, she always has a calculated and strong stand
	-
	- **Positive traits:**
		- She is caring even when she doesn't express it, wants the best for others and the universe
...
- **Quirks:**
	- She really never knew how to deal with [Soul]([[Alma-(Soul)]]), that little girl was the most unpredictable variable in any of her equations, even worse than Chaos shenanigans
	- After returning to be herself if a way to fuse existance and void back together is found, her walls will finally be broken,
	-
- **Sexuality:** Asexual aromantic
  
  **Motivations:** Of all guardians she is the one that embodies and accomplishes her purpose the most, she is strict and correct, and does anything needed to make sure the order of the universe is well preserved, and its laws continue working the way they should. If oblivion should arrive, it must, if the law says a civilization has to fall for the sake of the universe continuity, then it should. If not everything has must end
- ## Talents
...
- ## Relationships
  ...
  **Friends:** None as herself, she never let herself have those
...
-
- Think of her as the math, as the physics laws that tells you theres a limit on how fast you can go, that your water glass will be full and then will overflow and not be able to keep being filled forever
-
- She is not good nor evil, as not all peace is good and not all stillness is bad. She is the one who keep thing from going overboard, the one who prevents the universe to destroy itself in its natural chaos.
-
- Humans were that definition of uncontrolled chaos she could not accept. A story rewrote a thousand times, a fight we had for a five thousand  years. Humans deserve to live, but they will destroy the universe.
-
...
-
- Til the very end, even when she knew what i was, she only tried to talk with me, to sacrifice humanity to save me.
-
